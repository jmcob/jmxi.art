<template>
  <NavBar />
  <div class="hello">
    <h1>Gros pains de Vie, paroles de Dieu.</h1>
    <div class="cadre">
      <h2>Parole au hasard</h2>
      <p>{{ GetRandomWordOfGod().parole }}</p>
      <p>
        <em>{{ GetRandomWordOfGod().ref }}</em>
      </p>
    </div>
    <div class="cadre">
      <h2>Télécharger le PDF complet (pour impression)</h2>
      <p>
        ...
        <strong>
          ...
          notre Seigneur !</strong
        >
        <br /><br />Ils sont destinés à être utilisés dans l'Eglise.
        <br /><br />
...
Il est grand, le Seigneur, hautement loué ; à sa grandeur, il n'est pas de limite.`,
  ...
  methods: {
    GetRandomWordOfGod() {
      ...
      return this.paroles[roundedIndex];
    },
  },
  mounted() {
